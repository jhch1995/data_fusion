...
struct VectorR3;             // Space Vector (length 3)
struct VectorHgR3;           // Homogenous Space Vector
struct VectorR4;             // Space Vector (length 4)

struct LinearMapR3;          // Linear Map (3x3 Matrix)
struct AffineMapR3;          // Affine Map (3x4 Matrix)
struct RotationMapR3;        // Rotation (3x3 orthonormal matrix)
struct RigidMapR3;           // 3x4 matrix, first 3 columns orthonormal
...
inline double Mag(const VectorR3& u)
{
    return u.Norm();
}

inline double Dist(const VectorR3& u, const VectorR3& v)
{
    return u.Dist(v);
}
...
struct LinearMapR3 : public Matrix3x3 {
...
struct AffineMapR3 : public Matrix3x4 {
...
// *******************************************
// RotationMapR3 struct                       *
// * * * * * * * * * * * * * * * * * * * * * *
//用3 * 3的矩阵来表征旋转
struct RotationMapR3 : public Matrix3x3 {
...
public:
    ...
    //找到一个单位向量 满足该单位向量以原向量为旋转轴，旋转theta角后和u相同
...
// ***************************************************************
// * RigidMapR3 struct - prototypes.                              *                                                   *
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *

struct RigidMapR3 : public Matrix3x4
{
...
public:
    ...
    //用已知矩阵初始化变换矩阵并加上偏移量 A 是变换矩阵 t是偏移量
...
// *****************************************************
// * VectorR3 struct - inlined functions                *
// * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
{
    VectorR3 ret;
    common::Lerp( start, end, a, ret );
    return ret;
}


// ******************************************************
// * Matrix3x3  struct - inlined functions               *
// * * * * * * * * * * * * * * * * * * * * * * * * * * **
...
// ******************************************************
// * Matrix3x4  struct - inlined functions               *
// * * * * * * * * * * * * * * * * * * * * * * * * * * **
...
// ******************************************************
// * LinearMapR3 struct - inlined functions              *
// * * * * * * * * * * * * * * * * * * * * * * * * * * **
...
// ******************************************************
// * AffineMapR3 struct - inlined functions              *
// * * * * * * * * * * * * * * * * * * * * * * * * * * **
...
// **************************************************************
// RotationMapR3 struct (inlined functions)                      *
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * **
...
// **************************************************************
// RigidMapR3 struct (inlined functions)                         *
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * **
